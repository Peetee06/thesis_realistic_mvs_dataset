...
\begin{table}
	\centering
	\begin{tabular}{ccc} 			
		\textcolor{brownred}{\rule{0.5cm}{0.5cm}} & \textcolor{brownred}{\rule{0.5cm}{0.5cm}} & \textcolor{brownred}{\rule{0.5cm}{0.5cm}} \\
		\rotatebox[origin=c]{90}{test} & \rotatebox[origin=c]{90}{test} &
		\rotatebox[origin=c]{90}{test}
	\end{tabular}
	\caption{\todo{change Table \ref{table:semseg_colors} to this format with less distance between columns.}}
\end{table}
