...
Convolutional Neural Networks are Deep Neural Networks consisting of convolution layers, that extract features from input data, pooling layers, that \todo{??} and a fully connected network for classification. 
